      ...
      <div className="container-custom">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          <div className="md:col-span-2">
            <h2 className="text-2xl font-heading font-bold mb-4 gradient-text">Ariful</h2>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="text-gray-400">Ariful@example.com</li>
              <li>
        ...
        <div className="pt-6 mt-6 border-t border-gray-800 text-center text-gray-500 text-sm">
          <p>© {currentYear} Ariful | All Rights Reserved</p>
        </div>
      </div>
    </footer>
  );
